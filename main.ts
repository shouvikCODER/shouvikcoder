namespace SpriteKind {
    ...
    export const trasure = SpriteKind.create()
...
function start_level () {
    ...
    me.ay = 350
    info.setLife(5)
    tiles.placeOnRandomTile(me, assets.tile`myTile3`)
    ...
    for (let value of sprites.allOfKind(SpriteKind.trasure)) {
        sprites.destroy(value)
    }
    ...
    for (let value of tiles.getTilesByType(assets.tile`myTile5`)) {
        trasure = sprites.create(img`
            ...
            . b b . . . . . . . . . . b b . 
            `, SpriteKind.trasure)
        tiles.placeOnTile(trasure, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
    }
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.tree, function (sprite, otherSprite) {
    ...
    ghost.setPosition(me.x - 80, me.y - 80)
    ghost.follow(me, 95)
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.trasure, function (sprite, otherSprite) {
    info.changeScoreBy(3)
    sprites.destroy(otherSprite)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprites.destroy(otherSprite)
    if (me.y < otherSprite.y) {
        info.changeScoreBy(3)
    } else {
        info.changeLifeBy(-1)
    }
